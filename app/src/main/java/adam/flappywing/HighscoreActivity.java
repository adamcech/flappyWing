...
public class HighscoreActivity extends Activity {
    ...
    private class SelectAllScore extends AsyncTask<Void, Void, List<ScoreEntry>> {

        @Override
        protected List<ScoreEntry> doInBackground(Void... params) {
            return ScoreEntry.getAll();
        }

        @Override
        protected void onPostExecute(List<ScoreEntry> levelsList) {
